...
export const phrases: Phrase[] = [
  // === Приветствие и знакомство (15 фраз) ===
  {
    id: 'phrase_001',
 ...
 // === Направления и ориентация (10 фраз) ===  
  {
    id: 'phrase_077',
...
// МАССИВНОЕ РАСШИРЕНИЕ БАЗЫ ФРАЗ
// Добавить в конец массива phrases в src/data/phrases.ts

// ==== ЛИЧНАЯ ИНФОРМАЦИЯ (personal_info) ====

// Подкатегория: personal_name_age
{
  id: 'phrase_301',
...
// Подкатегория: personal_residence
{
  id: 'phrase_304',
  categoryId: 'personal_info',
...
// Подкатегория: personal_languages
{
  id: 'phrase_315',
  categoryId: 'personal_info',
...
// ==== ПРИВЕТСТВИЕ (greetings) - РАСШИРЕНИЕ ====
...
// ==== ЕДА (food) - НОВЫЕ ПОДКАТЕГОРИИ ====

// Подкатегория: food_appetizers
{
  id: 'phrase_325',
  categoryId: 'food',
...
// ==== ПОКУПКИ (shopping) - РАСШИРЕНИЕ ====

// Подкатегория: shopping_clothing
{
  id: 'phrase_344',
  categoryId: 'shopping',
...
// ==== ТРАНСПОРТ (transport) - РАСШИРЕНИЕ ====
...
// ==== ЭКСТРЕННЫЕ СИТУАЦИИ (emergency) - РАСШИРЕНИЕ ====
...
// ==== ОТЕЛЬ (hotel) - РАСШИРЕНИЕ ====

// Подкатегория: hotel_requests
{
  id: 'phrase_351',
  categoryId: 'hotel',
...
// ==== ЧАСТИ ТЕЛА (body) - НОВАЯ КАТЕГОРИЯ ====
...
// ==== БЛАГОДАРНОСТЬ И ВЕЖЛИВОСТЬ - РАСШИРЕНИЕ ====
...
// Подкатегория: business_conferences
{
  id: 'phrase_377',
  categoryId: 'business',
...
// Подкатегория: business_exhibitions
{
  id: 'phrase_381',
  categoryId: 'business',
...
// Подкатегория: business_negotiations
{
  id: 'phrase_385',
  categoryId: 'business',
...
// ==== СИСТЕМА МЕР И ВЕСОВ (measurements) ====

// Подкатегория: measurements_length
{
  id: 'phrase_389',
...
// Подкатегория: measurements_weight
{
  id: 'phrase_392',
  categoryId: 'measurements',
...
// Подкатегория: measurements_volume
{
  id: 'phrase_395',
  categoryId: 'measurements',
...
// ==== ВРЕМЯ (time) - РАСШИРЕНИЕ ====

// Подкатегория: time_days
{
  id: 'phrase_397',
  categoryId: 'time',
...
// ==== ИТОГО: +147 НОВЫХ ФРАЗ ====
// Общий объем: 177 (текущие) + 147 (новые) = 324 фразы!
