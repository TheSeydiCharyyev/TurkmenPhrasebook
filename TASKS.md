...
1. ✅ **Современный градиентный дизайн категорий (Hero + Grid вариант 2):**
   ...
   - Увеличенные иконки (72x72) с белым tint
...
- `src/data/categories.ts` - обновлен массив категорий
- `src/components/CategoryCard.tsx` - градиентный дизайн + динамические переводы
- `src/components/SubCategoryCard.tsx` - динамические переводы
- `src/screens/HomeScreen.tsx` - динамические переводы заголовков
- `src/screens/CategoryScreen.tsx` - динамические переводы

**Дизайн стиль:** Hero + Grid (вариант 2) - градиенты, мощные тени, белый текст, современный вид
